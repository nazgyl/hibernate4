 ...
 * @see com.santhosh.hibernate.Product
...
public class ProductHome {
	...
	public Product findById(com.santhosh.hibernate.ProductId id) {
		log.debug("getting Product instance with id: " + id);
		try {
			Product instance = (Product) sessionFactory.getCurrentSession()
					.get("com.santhosh.hibernate.Product", id);
			if (instance == null) {
	...
	public List<Product> findByExample(Product instance) {
		...
		try {
			List<Product> results = (List<Product>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.santhosh.hibernate.Product")
